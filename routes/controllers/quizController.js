...
const getCorrectAnswerPage = ({ params, render }) => {
    ...
    render("correctAnswer.eta", data); // Render the correct page
};

const getInCorrectAnswerPage = async ({ params, render }) => {
    const { tId: topicId, qId: questionId } = params;
...
export {
    ...
    getCorrectAnswerPage,
    getInCorrectAnswerPage,
    showQuizTopics,
};